  ...
  const navItems: AdminNavItem[] = useMemo(
    () => [
      ...
      },
      {
        ...
        icon: TrendingUp,
        children: [
          { title: "Traffic (soon)", url: "/dashboard/admin/analytics/traffic", icon: TrendingUp },
          { title: "Pages (soon)", url: "/dashboard/admin/analytics/pages", icon: FileText },
          { title: "Blog Performance (soon)", url: "/dashboard/admin/analytics/blog-performance", icon: Newspaper },
          { title: "Campaign (UTM) (soon)", url: "/dashboard/admin/analytics/campaign", icon: MessageSquare },
          { title: "Conversion (read-only) (soon)", url: "/dashboard/admin/analytics/conversion", icon: BarChart3 },
        ],
      },
